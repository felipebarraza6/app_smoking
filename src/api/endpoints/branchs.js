...
export const create = async (data) => {
  ...
  if (hasFiles) {
    const response = await POST_FORM("branches/", data);
    return response;
  } else {
...
export const update = async (id, data) => {
  ...
  if (hasFiles) {
    const response = await PATCH_FORM(`branches/${id}/`, data);
    return response;
  } else {
...
export const my_branches_select = async () => {
  const response = await GET("branches/my_branches_select/");
...
export const update_user_role = async (branchId, data) => {
  const response = await PUT(`branches/${branchId}/update_user_role/`, data);
  return response;
};
...
export const change_user_branch = async (branchId, userId, newBranchId) => {
  const response = await POST(`branches/${branchId}/change_user_branch/`, {
    user_id: userId,
