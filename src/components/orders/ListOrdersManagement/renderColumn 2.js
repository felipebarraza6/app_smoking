  ...
  return (
    <Flex gap="small" align="center" style={{ width: "100%" }}>
      ...
      <Descriptions bordered column={2} size="small" style={{ width: "100%" }}>
        <Descriptions.Item label="Cuotas Pagadas" span={2}>
          {`${paymentCount} de ${record.payment_fees || 0}`}
        </Descriptions.Item>
        ...
        <Descriptions.Item label="Valor Cuota">
          {`${formatCLP(feeValue)}`}
        </Descriptions.Item>
        ...
        <Descriptions.Item label="Pagos">
          <Flex gap="small" align="center" justify="space-between" wrap>
            {record.is_pay ? (
              <HiCheckBadge style={{ fontSize: "20px", color: "green" }} />
            ) : (
              <Button
                icon={<TbPigMoney />}
                size="small"
                disabled={record.is_pay || record.is_null}
