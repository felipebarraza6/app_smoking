...
import { Steps, Spin, Flex, Tag, Typography } from "antd";
...
const StepsNav = ({ mobile }) => {
      ...
      description: !mobile ? (
        <Flex gap="small" justify="center" vertical>
          <Text>
            ...
            {state.products.selected_products.length === 1
              ? "producto"
              : "productos"}
          </Text>
        </Flex>
  ...
  // Mobile: solo íconos en un flex horizontal
  return (
        ...
        return (
          <div
            ...
            style={{
              ...
              fontSize: 20,
              color: isCurrent ? "#d72660" : "inherit",
            }}
          >
            {item.icon}
          </div>
